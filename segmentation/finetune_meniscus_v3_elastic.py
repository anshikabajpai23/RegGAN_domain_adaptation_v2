"""
finetune_meniscus_v3_elastic.py
=================================
Same as finetune_meniscus_v2.py but uses dataset_2_5d_v3_elastic which adds
random elastic deformation to the v2 augmentation.

Change vs v2:
  + elastic deformation (alpha=30, sigma=4) applied to image+mask
  Loss, LR, encoder: identical to v2.

Purpose: test whether elastic deformation alone improves real PD Dice.
...
from dataset_2_5d_v3_elastic import Meniscus2_5DDataset
...
def main():
    ...
    log.info(f"Device: {device}  |  Augmentation: v2 + elastic deformation  |  Baseline: 0.6854")
